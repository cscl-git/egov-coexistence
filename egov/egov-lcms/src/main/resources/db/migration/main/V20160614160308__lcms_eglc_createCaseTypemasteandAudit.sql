...
INSERT INTO eg_role (id,"name",description,createddate,createdby,lastmodifiedby,lastmodifieddate,"version") VALUES (nextval('seq_eg_role'),'Super User','Super User',now(),1,1,now(),0);
