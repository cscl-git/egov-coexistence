...
public class LegalCase extends AbstractAuditable {
    ...
    @Column(name = "isreappealofcase")
    @Audited
    private Boolean isReappealOfCase;
    
    @Length(max = 100)
    @Column(name = "nodalofficer")
    @Audited
    ...
    @Length(max = 100)
    @Column(name = "estimatepreparedby")
    @Audited
	...
	public Boolean getIsReappealOfCase() {
		return isReappealOfCase;
	}

	public void setIsReappealOfCase(Boolean isReappealOfCase) {
		this.isReappealOfCase = isReappealOfCase;
	}
