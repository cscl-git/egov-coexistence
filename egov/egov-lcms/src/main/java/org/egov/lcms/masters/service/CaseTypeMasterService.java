...
public class CaseTypeMasterService extends PersistenceService<CaseTypeMaster, Long>{
    ...
    public CaseTypeMasterService() {
        super(CaseTypeMaster.class);
    }
    
    public CaseTypeMasterService(final Class<CaseTypeMaster> type) {
        super(type);
    }
