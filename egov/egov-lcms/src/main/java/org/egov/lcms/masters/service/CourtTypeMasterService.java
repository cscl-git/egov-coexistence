...
public class CourtTypeMasterService extends PersistenceService<CourtTypeMaster, Long>{

	@Autowired
    private CourtTypeMasterRepository courtTypeMasterRepository;

    @PersistenceContext
    private EntityManager entityManager;

    public CourtTypeMasterService() {
        super(CourtTypeMaster.class);
    }
    
    public CourtTypeMasterService(final Class<CourtTypeMaster> type) {
        super(type);
    }

    @Transactional
    public CourtTypeMaster create(final CourtTypeMaster courtTypeMaster) {
    	applyAuditing(courtTypeMaster);
