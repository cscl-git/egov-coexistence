...
@Entity
@Table(name = "eglc_division_master")
@Unique(id = "id", tableName = "eglc_division_master", columnName = { "code" }, fields = {
        "code" }, enableDfltMsg = true)
@SequenceGenerator(name = DivisionMaster.SEQ_PETITIONTYPE, sequenceName = DivisionMaster.SEQ_PETITIONTYPE, allocationSize = 1)
@AuditOverrides({ @AuditOverride(forClass = AbstractAuditable.class, name = "lastModifiedBy"),
        @AuditOverride(forClass = AbstractAuditable.class, name = "lastModifiedDate") })
public class DivisionMaster extends AbstractAuditable {
    private static final long serialVersionUID = 796823780349590496L;
    public static final String SEQ_PETITIONTYPE = "seq_eglc_division_master";
