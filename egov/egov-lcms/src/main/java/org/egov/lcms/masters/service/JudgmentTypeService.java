...
public class JudgmentTypeService extends PersistenceService<JudgmentType, Long>{
    ...
    public JudgmentTypeService() {
        super(JudgmentType.class);
    }
    
    public JudgmentTypeService(final Class<JudgmentType> type) {
        super(type);
    }

    @Transactional
    public JudgmentType persist(final JudgmentType judgmentType) {
    	applyAuditing(judgmentType);
