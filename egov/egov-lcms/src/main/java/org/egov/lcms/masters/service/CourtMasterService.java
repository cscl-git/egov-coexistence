...
public class CourtMasterService extends PersistenceService<CourtMaster, Long>{
	@Autowired
    ...
    public CourtMasterService() {
        super(CourtMaster.class);
    }
    
    public CourtMasterService(final Class<CourtMaster> type) {
        super(type);
    }
    
    @Transactional
    public CourtMaster persist(final CourtMaster courtMaster) {
    	applyAuditing(courtMaster);
