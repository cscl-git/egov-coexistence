...
public class AdvocateMasterService extends PersistenceService<AdvocateMaster, Long> implements EntityTypeService{
	@Autowired
    ...
    public AdvocateMasterService(final Class<AdvocateMaster> type) {
        super(type);
    }
    
    @Transactional
    public AdvocateMaster persist(final AdvocateMaster advocateMaster) {
    	applyAuditing(advocateMaster);
