...
public class PetitionTypeMasterService extends PersistenceService<PetitionTypeMaster, Long>{

	@Autowired
    private PetitionTypeMasterRepository petitionTypeMasterRepository;
    
    @PersistenceContext
    private EntityManager entityManager;

    public PetitionTypeMasterService() {
        super(PetitionTypeMaster.class);
    }
    
    public PetitionTypeMasterService(final Class<PetitionTypeMaster> type) {
        super(type);
    }

    @Transactional
    public PetitionTypeMaster create(final PetitionTypeMaster petitionTypeMaster) {
    	applyAuditing(petitionTypeMaster);
