      ...
      <div class="panel panel-primary" data-collapsed="0">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3 add-margin">
              <form:input path="identifier" class="form-control text-right patternvalidation" data-pattern="alphanumericwithspace" />
            ...
            <label class="col-sm-3 control-label text-right"><spring:message code="lbl.llevel" text="Level"/><span
              class="mandatory"></span>  </label>
            <div class="col-sm-3 add-margin">
              <form:input path="llevel" class="form-control text-right patternvalidation" data-pattern="alphanumericwithspace" required="required" />
