	...
	<table class="table table-bordered" id="tblcreditdetails">
		...
		<tbody>
			<tr id="creditdetailsrow">
				...
				<td class="text-center"><span style="cursor:pointer;" onclick="addCreditDetailsRow();" tabindex="0" id="tempCreditDetails[0].addButton" data-toggle="tooltip" title=""  aria-hidden="true"><i class="fa fa-plus"></i></span>
