...
@Repository
public interface ManageAuditorsRepository extends JpaRepository<ManageAuditor, Long> {

	ManageAuditor findById(Long id);
	...
	/*@Query("delete from eg_manageauditor b where b.id=:id")
	void deleteById(@Param("id") Long id);*/
	
	//List <ManageAuditors> findAll
