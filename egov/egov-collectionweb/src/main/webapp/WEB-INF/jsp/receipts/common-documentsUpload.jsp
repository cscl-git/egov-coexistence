...
<%-- <script src="<cdn:url value='/resources/js/commondocumentupload.js?rnd=${app_release_no}' context='/services/EGF'/>"></script> --%>
<%-- <script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/commondocumentupload.js?rnd=${app_release_no}"></script> --%>
