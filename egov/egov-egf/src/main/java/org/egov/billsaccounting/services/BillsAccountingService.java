 ...
 @Autowired
            ...
            throws ApplicationRuntimeException, ValidationException
    {
        ...
        try {
           ...
           vh = createVoucher.createVoucherFromBill(billId, voucherStatus, voucherNumber, voucherDate,null,null);
    ...
    public long createVoucherFromBill(final int billId) throws ApplicationRuntimeException
    {
        try {
            ...
            if (!vStatusList.isEmpty() && vStatusList.size() == 1)
            {
             ...
             final long vh = createVoucher.createVoucherFromBill(billId, voucherStatus, null, null,null,null);
            return vh;
        } catch (final Exception e)
        {
            LOGGER.error(e.getMessage());
