...
INSERT INTO EG_WF_MATRIX (id, department, objecttype, currentstate, currentstatus, pendingactions, currentdesignation, additionalrule, nextstate, nextaction, nextdesignation, nextstatus, validactions, fromqty, toqty, fromdate, todate) VALUES (nextval('seq_eg_wf_matrix'), 'ANY', 'LineEstimate', 'NEW', NULL, NULL, 'Assistant engineer', 'NEWLINEESTIMATE', 'Created', 'Pending Check', 'Superintending Engineer', 'Created', 'Forward', NULL, NULL, now(), now());
INSERT INTO EG_WF_MATRIX (id, department, objecttype, currentstate, currentstatus, pendingactions, currentdesignation, additionalrule, nextstate, nextaction, nextdesignation, nextstatus, validactions, fromqty, toqty, fromdate, todate) VALUES (nextval('seq_eg_wf_matrix'), 'ANY', 'LineEstimate', 'Created', NULL, NULL, 'Superintending Engineer', 'NEWLINEESTIMATE', 'Checked', 'Pending Budget sanction', 'Superintendent', 'Checked', 'Submit,Reject', NULL, NULL, now(), now());
...
INSERT INTO EG_WF_MATRIX (id, department, objecttype, currentstate, currentstatus, pendingactions, currentdesignation, additionalrule, nextstate, nextaction, nextdesignation, nextstatus, validactions, fromqty, toqty, fromdate, todate) VALUES (nextval('seq_eg_wf_matrix'), 'ANY', 'LineEstimate', 'Budget sanctioned', NULL, NULL, 'Commissioner', 'NEWLINEESTIMATE', 'Admin sanctioned', 'Pending Technical sanction', 'Superintending Engineer', 'Admin sanctioned', 'Submit,Reject', NULL, NULL, now(), now());
INSERT INTO EG_WF_MATRIX (id, department, objecttype, currentstate, currentstatus, pendingactions, currentdesignation, additionalrule, nextstate, nextaction, nextdesignation, nextstatus, validactions, fromqty, toqty, fromdate, todate) VALUES (nextval('seq_eg_wf_matrix'), 'ANY', 'LineEstimate', 'Admin sanctioned', NULL, NULL, 'Superintending Engineer', 'NEWLINEESTIMATE', 'END', 'END', NULL, NULL, 'Approve', NULL, NULL, now(), now());
INSERT INTO EG_WF_MATRIX (id, department, objecttype, currentstate, currentstatus, pendingactions, currentdesignation, additionalrule, nextstate, nextaction, nextdesignation, nextstatus, validactions, fromqty, toqty, fromdate, todate) VALUES (nextval('seq_eg_wf_matrix'), 'ANY', 'LineEstimate', 'Rejected', NULL, NULL, 'Assistant engineer', 'NEWLINEESTIMATE', 'Created', 'Pending Check', 'Superintending Engineer', NULL, 'Forward,Cancel', NULL, NULL, now(), now());
