		...
		<div class="col-md-12">
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title"><spring:message code="title.estimated.income.report" /></div>
				</div>
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							<select name="collectiontype" id="collectiontype" class="form-control" required="required">
								<option value=""><spring:message code="lbl.select" /></option>
								<option value="DAY_MARKET">Day Market</option>
								<option value="APNI_MANDI">Apni Mandi</option>
							</select>
						</div>
					</div>
					<div class="form-group">
...
<script src="<cdn:url value='/resources/js/app/estimated-income-report-helper.js?rnd=${app_release_no}'/>"></script>