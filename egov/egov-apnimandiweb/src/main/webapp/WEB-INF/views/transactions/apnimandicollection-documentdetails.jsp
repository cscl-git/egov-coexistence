...
<div class="panel panel-primary" data-collapsed="0">
	...
	<c:if test="${!apnimandiCollectionDetails.apnimandiCollectionDocuments.isEmpty() && mode == 'view' || mode =='edit'}">
		<c:forEach items="${apnimandiCollectionDetails.apnimandiCollectionDocuments}" var="apnimandiCollectionDoc">
			<a href="/services/egi/downloadfile?fileStoreId=${apnimandiCollectionDoc.filestoreid.fileStoreId}&moduleName=LCMS">${apnimandiCollectionDoc.filestoreid.fileName }</a><br />
		</c:forEach>
	</c:if>
	<c:if test="${mode == 'view' && apnimandiCollectionDetails.apnimandiCollectionDocuments.isEmpty()}">
