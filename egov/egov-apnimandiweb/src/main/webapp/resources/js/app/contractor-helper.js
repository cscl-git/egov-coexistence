			...
			},
			{
				...
				render : function(data, type, full) {
					if(full.statusCode == "APPROVED"){
						return ('<select class="dropchange" id="additionconn"><option>Select action</option><option value="1">View Contractor</option><option value="3">Terminate Contract / License</option></select>');
