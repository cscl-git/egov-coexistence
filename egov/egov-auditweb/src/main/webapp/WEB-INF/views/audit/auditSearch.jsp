...
<form:form name="auditForm" role="form" method="post"
	action="searchResult" modelAttribute="auditDetail" id="auditDetail"
		...
		<div class="tab-pane fade in active" id="searcheader">
			...
			<div class="panel panel-primary" data-collapsed="0">
				<div class="form-group" style="padding: 50px 20px 0;">
					...
					<label class="col-sm-3 control-label text-left-audit"><spring:message
							code="lbl.auditnumber" text="Audit Number" /> </label>
					<div class="col-sm-3 add-margin">
						<form:input class="form-control patternvalidation"
							data-pattern="alphanumericwithspecialcharacters" id="auditnumber"
							path="auditNumber" maxlength="50" />
					</div>
					...
					<div class="col-sm-3 add-margin">
						<form:select path="leadAuditorEmpNo" id="leadAuditorEmpNo"
							...
							<form:options items="${auditDetail.auditEmployees}"
								itemValue="empCode" itemLabel="empName" />
						</form:select>
					</div>
					<label class="col-sm-3 control-label text-left-audit">Pass
						Under Objection </label>
					<div class="col-sm-3 add-margin">
						<form:checkbox path="passUnderobjection" id="passUnderobjection"
							value="0"></form:checkbox>
					...
					<c:if
						...
						<center>
							<input type="submit" id="exportToExcel"
								...
								onclick="searchCheck()" value="Export to Excel" /> <input
								type="submit" id="exportToPdf"
								class="btn btn-primary btn-wf-primary" name="exportToPdf"
								onclick="searchCheck()" value="Export to Pdf" />
						</center>
					</c:if>
				</div>
				<br> <br>
