...
$(document).ready(function(){
	...
	var employee = new Bloodhound({
		...
		remote : {
			url : '/services/lcms/ajax/getemployeeNames',
...
function edit(legalCaseInterimOrder){  
		var url = '/services/lcms/lcinterimorder/edit/'+legalCaseInterimOrder;
		window.location = url;
       }
...
$('#createnewinterimorder').click(function() {
	var lcNumber = $('#lcNumber').val();
	var url = '/services/lcms/lcinterimorder/new/?lcNumber='+lcNumber;
...
function viewInterimorder(legalCaseInterimOrder){
	window.open('/services/lcms/lcinterimorder/view/' + legalCaseInterimOrder, "_self",'','height=650,width=980,scrollbars=yes,left=0,top=0,status=yes');
}
	
function vacatestay(Obj){  
	var url = '/services/lcms/vacatestay/new/?lcInterimOrderId='+Obj;
	window.location = url;
   }