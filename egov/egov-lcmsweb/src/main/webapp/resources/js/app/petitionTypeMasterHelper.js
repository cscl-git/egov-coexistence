...
function callAjaxSearch() {
	...
	jQuery('.report-section').removeClass('display-hide');
		reportdatatable = drillDowntableContainer
			.dataTable({
				ajax : {
					url : "/services/lcms/petitiontypemaster/ajaxsearch/"+$('#mode').val(),      
					type: "POST",
...
$("#resultTable").on('click','tbody tr',function(event) {
	window.open('/services/lcms/petitiontypemaster/'+ $('#mode').val() +'/'+drillDowntableContainer.fnGetData(this,4),'','width=800, height=600');
});