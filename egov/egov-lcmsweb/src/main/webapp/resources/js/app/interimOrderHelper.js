...
function callAjaxSearch() {
	...
	jQuery('.report-section').removeClass('display-hide');
		reportdatatable = drillDowntableContainer
			.dataTable({
				ajax : {
					url : "/services/lcms/interimorder/ajaxsearch/"+$('#mode').val(),      
					type: "POST",
...
$("#resultTable").on('click','tbody tr',function(event) {
	window.open('/services/lcms/interimorder/'+ $('#mode').val() +'/'+drillDowntableContainer.fnGetData(this,3),'','width=800, height=600');
});
