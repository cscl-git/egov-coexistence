			...
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="panel-body custom-form ">
					...
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							<form:input type="number" class="form-control patternvalidation"
								data-pattern="address" onkeyup="totalAmount();" maxlength="50" id="caseFee" path="caseFee"  />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							<form:select path=""  data-first-option="false"
								...
								id="status"  required="required" onchange="fillamount();">
								<form:option value="">
									<spring:message code="lbls.select" />
								</form:option>
					...
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							<form:input type="number" class="form-control" path="paymentOfIssuance" 
								id="paymentOfIssuance"  placeholder="0.0" pattern="0.0000"/>
						...
						<div class="col-sm-3 add-margin" id="personsdiv">
							<form:input  type="number" class="form-control"  id="findingOfReplyCase"
								path="findingOfReplyCase" placeholder="0.0" pattern="0.0000"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin" id="personsdiv">
							<form:input type="number" class="form-control"  id="finalDisposal"
								path="finalDisposal" placeholder="0.0" pattern="0.0000"/>
