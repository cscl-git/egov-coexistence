		...
		<div>
			<table>
				<tbody>
					<tr>
						<td valign="top">
						 	<table id="uploadertbl1"><tbody>
						 		<tr id="rows">			 				
									<td>
										<input type="file" name="file1" id="files1" onchange="isValidFile1(this.id)">
			...
			<div class="buttonbottom" align="center">
				...
				<button id="attachNewFileBtn" type="button" class="btn btn-primary" onclick="addFileInputField1()"><spring:message code="lbl.addfile" /></button>
				</div>
			</div>
		</div>
	</c:if>
