...
public class LegalCaseSearchJsonAdaptor implements JsonSerializer<LegalCaseSearchResult> {
    ...
    public JsonElement serialize(final LegalCaseSearchResult legalcaseresult, final Type typeOfSrc,
        ...
        jsonObject.addProperty("casestatus", legalcaseresult.getLegalCase().getStatusCode());
        ...
        jsonObject.addProperty("impcasesflag", legalcaseresult.getLegalCase().getImpcasesflag());
        jsonObject.addProperty("legalcaseremarks", legalcaseresult.getLegalCase().getLegalcaseremarks());
