...
function callAjaxSearch() {
	...
	reportdatatable = drillDowntableContainer
			.dataTable({
				ajax : {
					url : "/services/council/agenda/searchagenda-tocreatenotice",
					type : "POST",
					beforeSend : function() {
				...
				columns : [
						...
						},
						{
							...
							"render" : function(data, type, full, meta) {
								var mode = $('#mode').val();
								return '<button type="button" class="btn btn-xs btn-secondary view"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Create Notice</button>';
							}
						}, {
							"data" : "id",
							"visible" : false
...
$("#resultTable").on(
		...
		function(event) {
			...
			window.open('/services/council/councilmeeting/newNotice' + '/' + id, '',
