...
<form:hidden path="" id="pendingActions" name="pendingActions" value="${pendingActions}"/>
		...
		<div class="col-sm-8 add-margin">
			<form:textarea class="form-control patternvalidation" data-pattern="alphanumerichyphenbackslashampersand" path="approvalComent"  id="approvalComent" name="approvalComent" />
		</div>
	</div>
	</div>				
	</div>
