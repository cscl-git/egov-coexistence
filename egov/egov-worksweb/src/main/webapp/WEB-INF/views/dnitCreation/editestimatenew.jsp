...
<div class="panel panel-primary" data-collapsed="0">
	...
	<div class="form-group" style="padding: 50px 20px 680px;">
	...
	<div class="panel-heading">
		...
		<c:if test="${editable != 'N' }">
			...
			<br> <input type="file" name="file" id="fileboq"
				style="color: #000000;"><small class="error-msg">**Kindly use proper BOQ format to upload the BOQ details. Please ensure that there are no merge cells in the AOR Detail sheet</small>  <br>
