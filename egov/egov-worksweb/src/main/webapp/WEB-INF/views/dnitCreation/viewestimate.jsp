	...
	<div class="panel panel-primary" data-collapsed="0">
		<div class="form-group" style="padding: 50px 20px 870px;">
			...
			<div class="col-sm-3 add-margin">
				<form:select path="worksWing" id="worksWing" cssClass="form-control" readonly="true"
			...
			<div class="col-sm-3 add-margin">
				<form:select path="department" id="department" class="form-control" readonly="true"
					required="required">
									<form:option value="">
										<spring:message code="lbl.select" />
									</form:option>
			...
			<div class="col-sm-3 add-margin">
									<form:input id="estimateDate" path="estimateDate" readonly="true"
			...
			<div class="col-sm-3 add-margin">
				<form:input type="text" class="form-control" readonly="true" path="workLocation" />
							</div>

			<label class="col-sm-3 control-label text-left-audit1"><spring:message
					code="lbl.estimate.preparation.dnit.number" /></label>
			<div class="col-sm-3 add-margin">
				<form:input type="text" class="form-control" readonly="true" path="estimateNumber"
					readonly="true" />
					</div>
			...
			<div class="col-sm-3 add-margin">
				<form:select path="sectorNumber" id="sectorNumber" multiple="multiple" readonly="true"
			...
			<div class="col-sm-3 add-margin">
				<form:select path="wardNumber" id="wardNumber" multiple="multiple" readonly="true"
									cssClass="form-control-works" cssErrorClass="form-control error">
			...
			<div class="col-sm-3 add-margin">
				<form:input type="text" path="estimatePreparedBy" readonly="true"
...
<label class="col-sm-3 control-label text-left-audit1"><spring:message
				...
				<label class="col-sm-3 control-label text-left-audit1"><spring:message
					...
					<div class="col-sm-3 add-margin">
						<form:input type="number" path="consultantFee" value="" readonly="true"
							id="consultantFee" cssClass="form-control" onchange="valueChanged()"
							cssErrorClass="form-control-works error" />
							</div>
				...
				<label class="col-sm-3 control-label text-left-audit1"><spring:message
					...
					<div class="col-sm-3 add-margin">
						<form:input type="number" path="unforseenCharges" value="" readonly="true"
							id="unforseenCharges" cssClass="form-control" onchange="valueChanged()"
							cssErrorClass="form-control-works error" />
							</div>
			...
			<div class="col-sm-9 block-colm">
				<form:textarea class="form-control" readonly="true" path="workName" maxlength="2000" style="height: 100px;"
					 />
							</div>
			<label class="col-sm-3 control-label text-left-audit1"><spring:message
									code="lbl.estimate.preparation.necessity" /></label>
			<div class="col-sm-9 block-colm">
					<form:textarea class="form-control" readonly="true" path="necessity" maxlength="2000" style="height: 100px;"
					 />
							</div>
			<label class="col-sm-3 control-label text-left-audit1"><spring:message
									code="lbl.estimate.preparation.scope.work" /></label>
			<div class="col-sm-9 block-colm">
					 <form:textarea class="form-control" readonly="true" path="workScope" maxlength="2000" style="height: 100px;"
					 />
			</div>
							</div>
						</div>
				...
				<c:forEach var="mapboq" items="${milestoneList}" varStatus="mapstatus">
					<table id="boq${mapstatus.index}tableBoq" class="table table-bordered tableBoq">
						...
						<%-- <c:if test="${mapboq.key == boq.milestone }"> --%>
								...
								<form:input type="text" style="width:200px;" readonly="true"
									...
									<td><form:input type="text" style="width:400px;" readonly="true"
