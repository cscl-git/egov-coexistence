...
<script
	...
	<form:form name="search-estimate-form" role="form" method="post"
		action="searchEditDnit" modelAttribute="workdnitDetails"
	id="searchEditDnit" class="form-horizontal form-groups-bordered"
...
<label class="col-sm-3 control-label text-left-audit"><spring:message
		...
		<div class="buttonbottom" align="center">
			<input type="submit" id="searchEditDnit" class="btn btn-primary"
						name="searchEditDnit" code="lbl.search.work.estimate"
						value="Search" />
				</div>
					...
					<table class="table table-bordered" id="table">
						<thead>
							<tr>
								...
								<th><spring:message
										code="lbl.estimate.preparation.dnit.number" /></th>
								<th><spring:message
										code="lbl.estimate.preparation.dnit.date" /></th>
								<th><spring:message
								...
								<c:forEach items="${workdnitDetails.estimateList}"
									...
									<tr>
										...
										<td><form:hidden
											...
											<a href="#" onclick="editDNIT('${result.id}')">${result.estimateNumber }</a></td>
										<td><form:hidden
