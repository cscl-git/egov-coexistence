...
<div class="" data-collapsed="0" style=" scrollable:true;">
 <c:if test="${workOrderAgreement.docUpload != null &&  !workOrderAgreement.docUpload.isEmpty()}">
        ...
        <table id="table" class="table table-bordered">
						...
						<tbody>
        <c:forEach items="${workOrderAgreement.docUpload }" var="documentDetials" varStatus="loop">
