							...
							<c:forEach var="boq" items="${workOrderAgreement.boQDetailsList}"
								...
								<tr id="detailsrow" class="repeat-address">
									...
									<td><form:hidden
											...
											id="boQDetailsList[${status.index}].slNo" /> ${boq.slNo }</td>
									</td>
									<td>
										<%--  <form:hidden
									...
									<td>
										...
										<form:input type="number"
											...
											class="form-control rate" onchange="valueChanged(); getEstimateCost();"></form:input>
									...
									${boq.quantity} --%> <form:input type="number"
											...
											name="quantity" onchange="valueChanged(); getEstimateCost();"></form:input>
	...
	<script type="text/javascript">
		...
		function getEstimateCost(){ 
			...
			for (var i = 1; i < table.rows.length; i++) {
				...
				var amount = document.getElementById("boQDetailsList["
						+ (rIndex - 1) + "].amount").value;
	
				estimateAmt = estimateAmt + +amount; 
