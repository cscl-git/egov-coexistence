...
<script
    ...
    <script>
				$(document).ready(function() {<%@ page contentType="text/html;charset=UTF-8" language="java"%>
				<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
				<%@ taglib uri="http://www.springframework.org/tags" prefix="spring"%>
				<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
				<%@ taglib uri="/WEB-INF/taglibs/cdn.tld" prefix="cdn"%>
				...
				.table tbody > tr > td {
				    ...
				    vertical-align: top;
						...
						method="post" action="/services/works/dnit/dnitCreationEstApproval"
					...
					<div class="tab-pane fade in active" id="estimatescreen">
						...
						<div class="form-group" style="padding: 50px 20px 670px;">
								...
								<form:select path="department" id="department" class="form-control-works"
									...
									<div class="col-sm-3 add-margin">
								<form:input type="number" class="form-control-works" id="estimatedCost" path="estimateAmount" readonly="true"/>
											</div>
									<label class="col-sm-3 control-label text-left-audit1"><spring:message
					...
					<table id="boq${mapstatus.index}tableBoq" class="table table-bordered tableBoq">
						...
						<%-- <c:if test="${mapboq.key == boq.milestone }"> --%>
								...
								<%-- <form:input type="text" style="width:150px;"
											...
											required="required" class="form-control milestone"
											maxlength="200"></form:input></td> --%>
									<form:textarea type="text" style="width:350px;"
											path="boQDetailsList[${boq.sizeIndex}].item_description"
											id="boQDetailsList[${boq.sizeIndex}].item_description"
