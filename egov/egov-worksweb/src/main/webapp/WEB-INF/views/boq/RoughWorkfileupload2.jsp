...
<div class="" data-collapsed="0" style=" scrollable:true;">
   <c:if test="${workOrderAgreement.roughCostdocumentDetail != null &&  !workOrderAgreement.roughCostdocumentDetail.isEmpty()}">
        ...
        <table id="table" class="table table-bordered">
						...
						<tbody>
        <c:forEach items="${workOrderAgreement.roughCostdocumentDetail }" var="documentDetials" varStatus="loop">
        
        
       
						<tr>
						<td> <a href="/services/works/boq/downloadRoughWorkBillDoc?workDetailsId=${workOrderAgreement.id}&fileStoreId=${documentDetials.fileStore.fileStoreId }">${documentDetials.fileStore.fileName }</a><br />
						</td>
