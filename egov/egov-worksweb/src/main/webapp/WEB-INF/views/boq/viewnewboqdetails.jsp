...
<form:form name="newboqDetails-form" role="form" method="post"
	action="searchboqnew" modelAttribute="boqNewDetails" id="searchboqform"
			...
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="buttonbottom" align="center">
					<input type="submit" id="searchboqnew" class="btn btn-primary"
						name="searchboqnew" value="Search" />
				</div>
			</div>
	</div>
	<br> <br> <br>
								...
								<c:forEach items="${boqNewDetails.estimateList}"
									...
									<tr>
										...
										<td><form:hidden
												...
												id="estimateList[${status.index}].ref_dsr" />
											<a href="#" onclick="openBOQ('${result.id}')">${result.ref_dsr }</a></td>
										<td><form:hidden
