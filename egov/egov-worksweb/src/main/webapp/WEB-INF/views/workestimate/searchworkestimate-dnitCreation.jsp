...
<script
	...
	action="workEstimateSearchDnit" modelAttribute="workEstimateDetails"
						...
						test="${workEstimateDetails.estimateList != null &&  !workEstimateDetails.estimateList.isEmpty()}">
							<div class="buttonbottom" align="center">
								<input type="submit" id="save" class="btn btn-primary"
									name="searchBOQ" value="Search BOQ" />
				</div>
					</c:if>
				</div>
				<div style="padding: 0 15px;">
						...
						<%-- <c:if test="${mapboq.key == boq.milestone }"> --%>
									<tr id="boq${mapstatus.index}tableBoqrow"
										...
										<td><form:checkbox
											...
											<form:hidden path="newBoQDetailsList[${boq.sizeIndex}].slNo"
												id="newBoQDetailsList[${boq.sizeIndex}].slNo" /></td>
										<td><form:hidden
										...
										<td><form:hidden
												...
												id="newBoQDetailsList[${boq.sizeIndex}].unit" /> ${boq.unit }</td>
										<td><form:hidden
												path="newBoQDetailsList[${boq.sizeIndex}].rate"
												id="newBoQDetailsList[${boq.sizeIndex}].rate" /> ${boq.rate }</td>
										<td><form:hidden
						...
						test="${workEstimateDetails.newBoQDetailsList != null &&  !workEstimateDetails.newBoQDetailsList.isEmpty()}">
							<div class="buttonbottom" align="center">
								<input type="submit" id="saveboq" class="btn btn-primary"
									name="sendboqForDnit" value="Submit" />
						</div>
					</c:if>
				</div>
		</div>
