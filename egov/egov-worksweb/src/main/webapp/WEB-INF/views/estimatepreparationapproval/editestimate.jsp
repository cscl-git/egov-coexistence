...
.dropdown-content option:hover{
	...
	<c:if test="${error == 'Y' }">
		...
		<div class="form-group" style="padding: 50px 20px 870px;">
				...
				<input type="hidden" id="estStatus" name="estimatePreparationApproval"
				value="${estimatePreparationApproval.status.code}" />
				<input type="hidden" id="prevState" name="estimatePreparationApproval"
				value="${prevState}" />
				 <label
		...
		<label class="col-sm-3 control-label text-left-audit1"><spring:message
			...
			<div class="col-sm-3 add-margin">
			<form:input type="number" id="estimatedCost"
				class="form-control-works" path="estimateAmount" readonly="true" />
							</div>
			<label class="col-sm-3 control-label text-left-audit1"><spring:message
...
<label class="col-sm-3 control-label text-left-audit1"><spring:message
			...
			<form:input type="text" path="contingentAmount" id="contingentAmount"
				cssClass="form-control-works" readonly="true"
							cssErrorClass="form-control-works error" />
							</div>	
								...
								<form:hidden path="boQDetailsList[${boq.sizeIndex}].slNo"
								 ...
								 <form:input type="text" style="width:200px;"
									...
									<form:textarea type="text" style="width:400px;"
											...
											required="required" readonly="true"
											class="form-control item_description" maxlength="200"
											...
											id="boQDetailsList[${boq.sizeIndex}].ref_dsr"
												required="required" readonly="true"
												class="form-control ref_dsr" maxlength="200"
