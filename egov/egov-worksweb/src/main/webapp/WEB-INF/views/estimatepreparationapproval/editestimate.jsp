	...
	<div class="panel-heading">
		...
		<div id="mainContainerDiv">
			<%-- 	<c:if test="${fileuploadAllowed != 'Y' }">  --%>
					...
					<br>
					<input type="file" name="file" id="file1" style="color: #000000;"> <br>
					<form:hidden path="objectType" id="objectType" class="checklist_description" value="BoqUploadFile"></form:hidden>
					<br>
					
					<h4 style="color: #000000;">Boq Upload Remarks:<span class="mandatory"></span></h4>
					<div>
					<form:textarea class="form-control-works" style="height: 80px;" path="comments" id="comments"  maxlength="500"  />
					</div>
					<br>
		...
		<%-- 	</c:if>   --%>
			<div>
						...
						<%-- <c:if test="${mapboq.key == boq.milestone }"> --%>
								...
								<form:hidden path="boQDetailsList[${boq.sizeIndex}].slNo"
								 ...
								 <form:input type="text" style="width:200px;"
											...
											maxlength="200"  title="${boq.milestone}"></form:input> 
									...
									<form:textarea type="text" style="width:400px;"
											...
											maxlength="200"  title="${boq.item_description}" ></form:textarea></td>
											<td>
				...
				<c:forEach var="uploadId" items="${uploadDocID}">
				 <form:hidden path="uploadId" id="uploadId" class="checklist_description" value="${uploadId.id}"></form:hidden>
				 <form:hidden path="uploadfileStoreId" id="uploadfileStoreId" class="checklist_description" value="${uploadId.fileStore.id}"></form:hidden>
