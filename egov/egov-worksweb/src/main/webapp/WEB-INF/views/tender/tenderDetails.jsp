		...
		<div class="card">
			<div class="container">
				...
				<div class="vertical-center">
					<!-- <input type="submit" id="tenderBtn" class="btn-info"
						name="tenderBtn" code="lbl.save.tender"
						value="Save Tender Creation" /> -->
					<input type="submit" id="tenderSave" class="btn-info"
						name="tenderSave" code="lbl.save.tender" value="Save Tender Creation" />
				</div>
			</div>
		</div>
	</form:form>
