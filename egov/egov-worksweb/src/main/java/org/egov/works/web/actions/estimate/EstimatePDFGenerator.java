...
public class EstimatePDFGenerator extends AbstractPDFGenerator {
    ...
    public void generatePDF() {
        try {
            ...
            document.add(spacer());
            document.add(makePara("Estimate Created By: " + estimate.getCreatedBy()));
            document.add(spacer());
            document.add(spacer());
    ...
    public void displayHistory(final StateHistory stateHistory, final PdfPTable approvaldetailsTable) {
        if (!stateHistory.getValue().equals("NEW") && !stateHistory.getValue().equals("END")) {
            ...
            final Long positionId = stateHistory.getOwnerPosition();
            final DeptDesig deptdesig = null /*stateHistory.getOwnerPosition().getDeptDesig()*/;
