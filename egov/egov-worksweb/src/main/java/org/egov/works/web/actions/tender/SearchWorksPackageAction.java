        ...
        while (i.hasNext()) {
            ...
            if (wp.getCurrentState() != null) {
                if (!wp.getEgwStatus().getCode().equalsIgnoreCase(WorksConstants.APPROVED)
                    ...
                    final String posName = null;//wp.getState().getOwnerPosition().getName();
                    final Assignment assignment = null;/*assignmentService.getPrimaryAssignmentForPositon(wp.getState()
